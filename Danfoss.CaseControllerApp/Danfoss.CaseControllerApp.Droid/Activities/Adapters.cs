...
{
    [Register("mvvmcross.droid.support.v4.MvxCachingFragmentStatePagerAdapter2")]
    public class MvxCachingFragmentStatePagerAdapter2
        : MvxCachingFragmentPagerAdapter2
    {
        private readonly Context _context;

        protected MvxCachingFragmentStatePagerAdapter2(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
        }

        public MvxCachingFragmentStatePagerAdapter2(Context context, FragmentManager fragmentManager,
    ...
    [Register("mvvmcross.droid.support.v4.MvxCachingFragmentPagerAdapter2")]
    public abstract class MvxCachingFragmentPagerAdapter2 : PagerAdapter
    {
        ...
        protected MvxCachingFragmentPagerAdapter2(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
        }

        protected MvxCachingFragmentPagerAdapter2(FragmentManager fragmentManager)
        {
        ...
        public override void RestoreState(IParcelable state, ClassLoader loader)
        {
            ...
            foreach (var key in keys)
            {
                ...
                if (f != null)
                {
                    ...
                    _fragments[index] = f;
                    f.CastInstanceTo<MvxFragment>().ViewModel = GetItem(index).CastInstanceTo<MvxFragment>().ViewModel;
                }
            }
        }
